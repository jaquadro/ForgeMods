...
public class ModPlantMegaPackHandler implements IPlantHandler
{
    ...
    public boolean init () {
        ...
        try {
            ...
            FMLLog.log(ModularPots.MOD_ID, Level.SEVERE, "Could not initialize the Plant Mega Pack handler.");
    ...
    public boolean applyBonemeal (World world, int x, int y, int z) {
        ...
        try {
            ...
            FMLLog.log(ModularPots.MOD_ID, Level.SEVERE, e, "Failed to apply bonemeal in Plant Mega Pack handler.");
            result = false;
        }
